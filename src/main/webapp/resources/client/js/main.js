(function ($) {
    ...
    $('#btnFilter').click(function (event) {
        event.preventDefault();// Ngăn refresh lại trang khi bấm vào buttonbutton #btnFilter
        let factoryArr = [];
        let targetArr = [];
        let priceArr = [];

        //factory filter lấy ra tất cả thẻ check check box factory
        ...
        //kết thúc đưa giá trị lọc vào 3 array
        ...
        // Add or update query parameters set các query parameters lên urlurl
        searchParams.set('page', '1');//khi lọc sản phẩm auto về trang 1
